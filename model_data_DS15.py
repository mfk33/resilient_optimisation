...
CostFuel_stop = 52500 # monetary units, extra fuel cost per fuel stop for bulk ships
...
N_ships_availB = 7 # Optional: Maximum number of bulk ships available from Immingham
...
container_travel_time = {
    ('Mundra', 'Suez'): 33, ('Mundra', 'Cape'): 55,
    ('Mumbai', 'Suez'): 35, ('Mumbai', 'Cape'): 57,
    ('Chennai', 'Suez'): 39, ('Chennai', 'Cape'): 61
}
...
base_bulk_travel_time_0_stops = {
    ('Mundra', 'Suez'): 22, ('Mundra', 'Cape'): 39,
    ('Mumbai', 'Suez'): 24, ('Mumbai', 'Cape'): 41,
    ('Chennai', 'Suez'): 28, ('Chennai', 'Cape'): 44
}
