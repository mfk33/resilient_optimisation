...
Toll_Suez_Container = 10200 # monetary units, cost for one container ship transit via Suez
Toll_Suez_Bulk = 268800      # monetary units, cost for one bulk ship transit via Suez
DailyCharterRateB = 11000 # monetary units, cost per day to charter one bulk ship
CostScrapMetal = 750 # MOnetary units per metric ton 
AddedDays_stop = 2 # days, time added to journey per fuel stop for bulk ships
CostFuel_stop = 43750 # monetary units, extra fuel cost per fuel stop for bulk ships
R_interest = 0.00064 # daily interest rate for commodity value (e.g., 0.032%)
...
base_bulk_fuel_cost = {
    ('Mundra', 'Suez'): 125000, ('Mundra', 'Cape'): 137500,
    ('Mumbai', 'Suez'): 131250, ('Mumbai', 'Cape'): 143750,
    ('Chennai', 'Suez'): 137500, ('Chennai', 'Cape'): 150000
}
