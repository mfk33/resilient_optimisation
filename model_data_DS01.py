...
container_shipping_cost = {
    ('Mundra', 'Suez'): 130, ('Mundra', 'Cape'): 143,
    ('Mumbai', 'Suez'): 143, ('Mumbai', 'Cape'): 156,
    ('Chennai', 'Suez'): 169, ('Chennai', 'Cape'): 182
}

# MaxTonC_s_p: Max container tonnage per month on route (s,p)
max_container_tonnage_route = {
    ('Mundra', 'Suez'): 40000, ('Mundra', 'Cape'): 40000,
    ('Mumbai', 'Suez'): 30000, ('Mumbai', 'Cape'): 30000,
    ('Chennai', 'Suez'): 10000, ('Chennai', 'Cape'): 10000
}

# TimeC_s_p: Container travel time in days
container_travel_time = {
    ('Mundra', 'Suez'): 70, ('Mundra', 'Cape'): 60,
    ('Mumbai', 'Suez'): 70, ('Mumbai', 'Cape'): 60,
    ('Chennai', 'Suez'): 70, ('Chennai', 'Cape'): 61
}
...
base_bulk_travel_time_0_stops = {
    ('Mundra', 'Suez'): 70, ('Mundra', 'Cape'): 42,
    ('Mumbai', 'Suez'): 70, ('Mumbai', 'Cape'): 44,
    ('Chennai', 'Suez'): 70, ('Chennai', 'Cape'): 48
}
