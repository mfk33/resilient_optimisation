...
DailyCharterRateB = 14300 # monetary units, cost per day to charter one bulk ship
CostScrapMetal = 300 # MOnetary units per metric ton 
AddedDays_stop = 2 # days, time added to journey per fuel stop for bulk ships
CostFuel_stop = 42000 # monetary units, extra fuel cost per fuel stop for bulk ships
...
N_ships_availB = 8 # Optional: Maximum number of bulk ships available from Immingham
...
container_travel_time = {
    ('Mundra', 'Suez'): 30, ('Mundra', 'Cape'): 65,
    ('Mumbai', 'Suez'): 32, ('Mumbai', 'Cape'): 68,
    ('Chennai', 'Suez'): 35, ('Chennai', 'Cape'): 72
}
...
base_bulk_travel_time_0_stops = {
    ('Mundra', 'Suez'): 20, ('Mundra', 'Cape'): 46,
    ('Mumbai', 'Suez'): 22, ('Mumbai', 'Cape'): 48,
    ('Chennai', 'Suez'): 25, ('Chennai', 'Cape'): 52
}
