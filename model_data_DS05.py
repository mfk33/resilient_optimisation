...
DailyCharterRateB = 12100 # monetary units, cost per day to charter one bulk ship
...
container_shipping_cost = {
    ('Mundra', 'Suez'): 110, ('Mundra', 'Cape'): 121,
    ('Mumbai', 'Suez'): 121, ('Mumbai', 'Cape'): 132,
    ('Chennai', 'Suez'): 143, ('Chennai', 'Cape'): 154
}
...
container_travel_time = {
    ('Mundra', 'Suez'): 36, ('Mundra', 'Cape'): 60,
    ('Mumbai', 'Suez'): 38, ('Mumbai', 'Cape'): 62,
...
base_bulk_travel_time_0_stops = {
    ('Mundra', 'Suez'): 24, ('Mundra', 'Cape'): 42,
    ('Mumbai', 'Suez'): 26, ('Mumbai', 'Cape'): 44,
