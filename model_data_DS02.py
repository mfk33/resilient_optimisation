...
Toll_Suez_Container = 11050 # monetary units, cost for one container ship transit via Suez
Toll_Suez_Bulk = 291200      # monetary units, cost for one bulk ship transit via Suez
DailyCharterRateB = 11000 # monetary units, cost per day to charter one bulk ship
CostScrapMetal = 300 # MOnetary units per metric ton 
AddedDays_stop = 2 # days, time added to journey per fuel stop for bulk ships
CostFuel_stop = 38500 # monetary units, extra fuel cost per fuel stop for bulk ships
...
N_ships_availB = 10 # Optional: Maximum number of bulk ships available from Immingham
...
container_shipping_cost = {
    ('Mundra', 'Suez'): 150, ('Mundra', 'Cape'): 165,
    ('Mumbai', 'Suez'): 165, ('Mumbai', 'Cape'): 180,
    ('Chennai', 'Suez'): 195, ('Chennai', 'Cape'): 210
}
...
container_travel_time = {
    ('Mundra', 'Suez'): 30, ('Mundra', 'Cape'): 55,
    ('Mumbai', 'Suez'): 32, ('Mumbai', 'Cape'): 57,
    ('Chennai', 'Suez'): 35, ('Chennai', 'Cape'): 60
}
...
base_bulk_travel_time_0_stops = {
    ('Mundra', 'Suez'): 20, ('Mundra', 'Cape'): 38,
    ('Mumbai', 'Suez'): 22, ('Mumbai', 'Cape'): 41,
    ('Chennai', 'Suez'): 25, ('Chennai', 'Cape'): 44
}
